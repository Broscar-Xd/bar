...
<div class="container">
    ...
    <div class="card-body">
            ...
            <input type="text" readonly class="form-control" id="staticEmail" value="{{$campu->nombre}}">
        </div>
                                <div class="form-group">
            <label class="col-form-label" for="value">Direccion</label>
            <input type="text" readonly class="form-control" id="staticEmail" value="{{$campu->direccion}}">
        </div>
                                                                    </div>
