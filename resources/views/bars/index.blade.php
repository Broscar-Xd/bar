                ...
                <div class="card-body">
                    ...
                    <table class="table table-bordered table-success">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <a href="{{route('bars.show',['bar'=>$bar] )}}" class="btn btn-primary"><svg
                                    ...
                                    <a href="{{route('bars.edit',['bar'=>$bar] )}}" class="btn btn-secondary"><svg
                                            width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-wrench"
                                            fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                            <path fill-rule="evenodd"
                    ...
                    document.getElementById('delete-bar-{{$bar->id}}').submit();" class="btn btn-danger">
                                    ...
                                    <form id="delete-bar-{{$bar->id}}" action="{{route('bars.destroy',['bar'=>$bar])}}"
                ...
                <div class="card-footer text-muted">
                    <div class="row">
                        ...
                        <div class="col-8" style="text-align:left;padding-left  :35px">
                            <a href="{{route('bars.create')}}" class="btn btn-success"><svg width="1em" height="1em"
