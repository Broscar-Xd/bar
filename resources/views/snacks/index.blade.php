            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-bordered table-primary">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <a href="{{route('snacks.show',['snack'=>$snack] )}}" class="btn btn-info"><svg
                                        ...
                                        <a href="{{route('snacks.edit',['snack'=>$snack] )}}"
                    ...
                    document.getElementById('delete-snack-{{$snack->id}}').submit();" class="btn btn-danger">
                                        ...
                                        <form id="delete-snack-{{$snack->id}}"
                                            action="{{route('snacks.destroy',['snack'=>$snack])}}" method="POST"
                                            style="display: none;">
                                            @csrf
                                            @method('DELETE')
                                        </form>
                ...
                <div class="card-footer text-muted">
                    <div class="row">
                        ...
                        <div class="col-8" style="text-align:left;padding-left  :35px">
                            <a href="{{route('snacks.create')}}" class="btn btn-success"><svg width="1em" height="1em"
