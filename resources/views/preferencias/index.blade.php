                ...
                <div class="card-body">
                    ...
                    <table class="table table-bordered table-danger">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <a href="{{route('preferencias.show',['preferencia'=>$preferencia] )}}"
                                        class="btn btn-info"><svg width="1em" height="1em" viewBox="0 0 16 16"
                                    ...
                                    <a href="{{route('preferencias.edit',['preferencia'=>$preferencia] )}}"
                                        class="btn btn-secondary"><svg width="1em" height="1em" viewBox="0 0 16 16"
                    ...
                    document.getElementById('delete-preferencia-{{$preferencia->id}}').submit();"
                                    ...
                                    <form id="delete-preferencia-{{$preferencia->id}}"
                                        action="{{route('preferencias.destroy',['preferencia'=>$preferencia])}}"
            ...
            <div class="card-footer text-muted">
                <div class="row">
                    ...
                    <div class="col-4" style="text-align:left;padding-left  :35px">
                        <a href="{{route('preferencias.create')}}" class="btn btn-success"><svg width="1em" height="1em"
                                viewBox="0 0 16 16" class="bi bi-file-earmark-plus" fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                    ...
                    <div class="col-4" style="text-align:center">
                        <a href="../public/menus" class="btn btn-info"><svg width="1em" height="1em" viewBox="0 0 16 16"
                    ...
                    <div class="col-4" style="text-align:right;padding-right  :35px">
                        <a href="../public/home" class="btn btn-warning"><svg width="1em" height="1em"
