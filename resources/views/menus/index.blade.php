                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-bordered table-danger">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <a href="{{route('menus.show',['menu'=>$menu] )}}" class="btn btn-info"><svg
                ...
                <div class="card-footer text-muted">
                    <div class="row">
                        ...
                        <div class="col-4" style="text-align:left;padding-left  :35px">
                            <a href="{{route('menus.create')}}" class="btn btn-success"><svg width="1em" height="1em"
                        ...
                        <div class="col-4" style="text-align:center">
                            <a href="../public/preferencias" class="btn btn-info"><svg width="1em" height="1em"
