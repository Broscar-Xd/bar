        ...
        <div class="card">
                ...
                <div class="card-body">
                    ...
                    <table class="table table-bordered table-secondary">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <a href="{{route('campuses.show',['campus'=>$campus] )}}" class="btn btn-info"><svg
                    ...
                    document.getElementById('delete-campus-{{$campus->id}}').submit();" class="btn btn-danger">
                                    ...
                                    <form id="delete-campus-{{$campus->id}}"
                                        action="{{route('campuses.destroy',['campus'=>$campus])}}" method="POST"
                                        style="display: none;">
                                        @csrf
                                        @method('DELETE')
                                    </form>
            ...
            <div class="card-footer text-muted">
                    ...
                    <div class="col-8" style="text-align:left;padding-left  :35px">
                            <a href="{{route('campuses.create')}}" class="btn btn-success"><svg width="1em" height="1em"
